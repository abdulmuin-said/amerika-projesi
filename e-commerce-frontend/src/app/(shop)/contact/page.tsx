                    ...
                    <div className="lg:col-span-5 space-y-6">
                            ...
                            <div className="space-y-5 text-sm">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:concierge@novacanvas.com" className="text-stone-600 hover:text-stone-900 transition-colors">
                                            concierge@novacanvas.com
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="bg-[oklch(0.42_0.02_55)] rounded-2xl p-6 text-white text-sm">
                            ...
                            <p className="text-white/70 text-xs leading-relaxed">
                                Every NovaCanvas Studios artwork is printed with archival inks on 380gsm cotton canvas and carefully packed in reinforced timber packaging.
                            </p>
                        </div>
                    </div>
                            ...
                            {submitted ? (
                                <div className="py-12 text-center space-y-4">
                                    ...
                                    <p className="text-stone-600 max-w-md mx-auto text-sm">
                                        Thank you for contacting NovaCanvas Studios. An art advisor has been assigned to your request and will reach out shortly.
                                    </p>
                                    <Button
